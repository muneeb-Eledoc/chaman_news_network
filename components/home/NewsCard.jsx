...
const NewsCard = ({story}) => {
  return (
    ...
    <div className='cursor-pointer p-1 w-full shadow active:scale-95 active:bg-gray-100 rounded transition-all duration-100'>
        <div className="flex">
        ...
        <div className="flex mt-2 mb-2 flex-row-reverse">
          <h3 className='text-right text-xs mr-1 mb-1 md:text-sm leading-4'>{story.title.substring(0, 40)}</h3>
        </div>
    </div>
    </Link>
  )
