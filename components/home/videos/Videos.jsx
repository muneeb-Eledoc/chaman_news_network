  ...
  return (
    <div className='mb-8 flex lg:flex-row-reverse flex-col flex-1'>
      <div className="flex flex-col basis-5/12 border-l border-gray-200">
        <h1 className='text-right font-semibold py-2 border-r-4 border-yellow-400 pr-2 text-lg'>ویڈیوز</h1>
      ...
      <div className="flex lg:flex-row-reverse flex-col basis-7/12 mx-1">
        <div className="flex flex-col w-full">
          <h1 className='text-right font-semibold py-2 border-r-4 border-yellow-400 pr-2 text-lg'>تازہ ترین ویڈیوز</h1>
          <hr className='my-2 mx-2' />
        ...
        <div className="w-full">
          <h1 className='text-right font-semibold py-2 border-r-4 border-yellow-400 pr-2 text-lg'>نیوز ہیڈلائن</h1>
          <hr className='my-2 mx-2' />
