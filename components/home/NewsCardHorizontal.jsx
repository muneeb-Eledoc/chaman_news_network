...
const NewsCardHorizontal = ({latest}) => {
  return latest && (
    ...
    <div className='flex flex-col py-2 px-1 cursor-pointer bg-white rounded shadow mx-1 active:scale-95 transition-all duration-75'>
        <h4 className='text-right text-sm md:text-[16px] mb-5 mt-1 mx-2 hover:text-green-700 font-medium max-h-[36px] tracking-wide leading-[30px] sm:leading-[10px]'>{latest.title.substring(0,60)}</h4>
